...
export const ITEM_LIST = {
    SOY_CUBA: new OverlayItem("Soy Cuba", OVERLAY_ITEM_TYPE.VIDEO, "https://www.youtube.com/embed/BwEabZrGFfI", null), // Film
	PHARCYDE: new OverlayItem("The Pharcyde - Drop", OVERLAY_ITEM_TYPE.VIDEO, "https://www.youtube.com/embed/wqVsfGQ_1SU", null), // Music Video
	MONA_LISA: new OverlayItem("Mona Lisa",OVERLAY_ITEM_TYPE.VIDEO, "https://www.youtube.com/embed/wqVsfGQ_1SU", null), // 
	LOREM_IPSUM: new OverlayItem("Lorem Ipsum", OVERLAY_ITEM_TYPE.TEXT, null, "Butcher 3 wolf moon affogato four loko fixie bodega boys biodiesel pitchfork whatever"), // 
