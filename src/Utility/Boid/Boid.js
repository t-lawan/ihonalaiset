...
import { BoidHelper } from '../BoidHelper/BoidHelper';
...
export default class Boid {
  ...
  update(delta, neighbours, obstacles) {
    ...
    if (collisionResults.length > 0) {
      ...
      // gently dodge object
      for (var i = 0; i < BoidHelper.sphereCastDirections.length; i++) {
        const direction = BoidHelper.sphereCastDirections[i]
